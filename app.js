...
const app = new App({
    token: config.get('secrets.rd-prod.rd-slack-bot-token'), //disable this if enabling OAuth in socketModeReceiver
    // logLevel: LogLevel.DEBUG,
    appToken: config.get('secrets.rd-prod.rd-slack-app-token'),
    socketMode: true,
});
